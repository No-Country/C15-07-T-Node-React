...
import { AMENITIES } from '../../router/paths';

function TableAmenities() {
  const data = [
    {
      id: '5146846548465',
      name: 'Jane Cooper',
      ...
      <div className='flex items-start justify-between px-4'>
        <div className='flex flex-col gap-1'>
          <h3 className='text-base font-bold text-gray-900'>
            Solicitudes recientes de Amenidades
          </h3>
          <h4 className='text-xs font-normal text-gray-500'>
            Aquí podras encontrar las ultimas solicitudes de Amenidades
          </h4>
        </div>
        <Link to={AMENITIES}>
